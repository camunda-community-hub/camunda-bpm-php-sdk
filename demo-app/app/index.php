          ...
          <table class="table table-bordered table-striped">
            ...
            foreach($taskRequest->getData() AS $data) {
              ...
              <tr>
                ...
                <td>
                  <a href="showDetails.php?type=task&id=<?php echo $data->id; ?>" class="btn btn-mini">Details</a>
                </td>
              </tr>
            <?php } ?>
          </table>
        ...
        <div class="tab-pane" id="processInstances">
          <table class="table table-bordered table-striped">
            ...
            foreach($processInstanceRequest->getData() AS $data) {
              ...
              <tr>
                <td><?php echo $data->id; ?></td>
                <td><?php echo $data->definitionId; ?></td>
                <td><?php echo $data->businessKey; ?></td>
                <td>
                  <a href="showDetails.php?type=processInstance&id=<?php echo $data->id ?>" class="btn btn-mini">Details</a>
                </td>
              </tr>
            <?php } ?>
          </table>
