...
require_once('../../../sdk/entity/Request.php');
require_once('../../../sdk/service/RestService.php');
require_once('../../../sdk/service/TaskService.php');
...
$restRequest = new TaskService("http://localhost:8080/engine-rest");

$restRequest->getTaskCount();
